  ...
  >
    ...
    <clipPath :id="id" :style="getJarCss">
      <path
        ...
        id="CoffeeLiquid"
        d="M30.112,15.51c0,0 -3.912,3.765 -5.849,3.765c-1.926,0 -3.851,-3.765 -5.776,-3.765c-1.937,0 -3.912,3.765 -5.849,3.765c-1.926,0 -5.776,-3.765 -5.776,-3.765l0,18.589l23.25,0l0,-18.589Z"
      />
    </clipPath>
    <g :clip-path="`url(#${id})`">
      <path
...
export default class CoffeeCard extends Vue {
  ...
  mounted() {
    this.timeline.add({
      ...
      d: {
        value: [
          "M30.112,15.51c0,0 -3.912,-3.735 -5.849,-3.735c-1.926,0 -3.851,3.735 -5.776,3.735c-1.937,0 -3.912,-3.735 -5.849,-3.735c-1.926,0 -5.776,3.735 -5.776,3.735l0,18.589l23.25,0l0,-18.589Z",
        ],
        duration: 500,
        easing: "linear",
      },
